...
<template>
  <div class="relative size-full min-w-0 overflow-hidden">
    ...
    <div
      class="absolute top-4 left-4 z-10 w-64 rounded-xl bg-background/95 shadow-lg backdrop-blur-sm"
    >
      <div class="p-4">
      ...
      <div class="space-y-2 border-t border-border p-4">
        ...
        >
          ...
          <Icon name="lucide:check-circle-2" class="size-4 text-emerald-500" />
        </div>
