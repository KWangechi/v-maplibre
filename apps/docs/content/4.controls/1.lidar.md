...
::callout{icon="i-lucide-external-link" to="https://mapcn-vue.geoql.in/examples/lidar-copc" target="_blank"}
...
```typescript
import type { LidarControlOptions, ColorScheme, CopcLoadingMode, PointCloudInfo, PointCloudBounds } from '@geoql/v-maplibre/lidar';
```
