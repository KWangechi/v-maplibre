...
```bash
pnpm add @developmentseed/deck.gl-raster @developmentseed/deck.gl-geotiff @developmentseed/geotiff flatbush proj4
```
...
```bash
pnpm add maplibre-gl-interpolate-heatmap
```
